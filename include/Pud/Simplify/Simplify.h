...
class SimplifyVisitor : public CallbackASTVisitor<ExprPtr, StmtPtr> {
 ...
 public:
  ...
  static auto apply(const std::shared_ptr<SimplifyContext>& ctx,
 ...
 private:
  /// Basic type expressions (Basic.cc)
  ...
  /* Identifier access expressions (access.cc) */
  ...
  /* Collection and comprehension expressions (collections.cc) */
  ...
  /* Conditional expression and statements (cond.cc) */
  ...
  /* Errors and exceptions (error.cc) */
